...
int main() {
    ...
    const auto path = std::filesystem::temp_directory_path() / "worldsim_soil_capacity_v6.wsmw";
    ...
    check(version == 6u, "capacity-aware multiresolution persistence writes format v6");
    {
