...
int main() {
    ...
    const auto path = std::filesystem::temp_directory_path() / "worldsim_soil_capacity_v5.wsmw";
    ...
    check(version == 5u, "capacity-aware multiresolution persistence writes format v5");
    {
