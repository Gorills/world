...
int main() {
    ...
    const auto path = std::filesystem::temp_directory_path() / "worldsim_soil_capacity_v4.wsmw";
    ...
    check(version == 4u, "capacity-aware multiresolution persistence writes format v4");
    {
